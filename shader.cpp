...
void Shader::UpdateCamera(Camera camera){
    //printf("Updating camera to following positions: %f %f %f",camera.GetX(),camera.GetY(),camera.GetZ());
    GLint cameraPosLocation = glGetUniformLocation(program,"camera_pos");
